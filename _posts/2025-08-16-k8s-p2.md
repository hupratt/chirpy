...
The client goes to the DNS server k8s.thekor.eu which points to 192.168.3.82 and 192.168.3.83. The worker node01 or worker node02 forwards it to ingress who forwards it to the ingress controller. The request then gets forwarded to the web app's svc who forwards it to the pod
