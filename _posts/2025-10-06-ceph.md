...
If you do however you'll want to recreate the partitions:
...
Tear down the cluster. This won't delete the ceph pools created during the install so if you're interested in doing that look into the next section: "removing OSDs"
...
OSDs are the ceph partitions that we gave ceph to work on. To remove them here's the process: 
