...
If the command above failed it probably means that you're running this command with mounted file systems
...
for reasons i can't explain yet, the coredns running on the cluster does not have the service ip i set on kubespray. To fix this:
